...
<body>
		...
		<nav class="naveg">
			...
			<ul class="navbar">
				...
				<li><a href="#empresas">Empresas</a></li>
                                <li></li>
                                <li><a class="unlog" href="login.jsp">Deslogueate</a></li>
			</ul>
		</nav>
	</header>
	...
	<section id="audiovisuales">
		...
		<a href="audiovisuales.jsp">Accede aquí</a>
	</section>
