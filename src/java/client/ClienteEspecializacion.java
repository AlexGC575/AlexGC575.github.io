...
/**
 * Jersey REST client generated for REST resource:EspecializacionFacadeREST
 * [ws.especializacion]<br>
 * USAGE:
 * <pre>
 ...
 * @author juanl
 */
public class ClienteEspecializacion {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/RestUparty/webresources";

    public ClienteEspecializacion() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("ws.especializacion");
    }
