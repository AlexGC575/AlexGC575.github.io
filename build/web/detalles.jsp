        ...
        <s:form action="validarDetalles">
            ...
            <s:iterator value="lugares" var="l">
                <details>
                    ...
                    <s:radio id="radio" name="elegirLugar" list="#l.getNombre()" onclick="rellenarLugar(this.value)"/>
            </s:iterator> 
            ...
            <s:textfield name="fecha" label="Fecha"/><br/>
            <s:textfield id="horaI" name="horaI" label="Hora inicio"/><br/>
            <s:textfield id="horaF"  name="horaF" label="Hora fin"/><br/>
